    ...
    <Layout>
      ...
      <section ref={heroRef} className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <h1 data-reveal data-reveal-delay="150" className="font-heading text-4xl md:text-6xl lg:text-7xl text-primary-foreground mb-8 leading-tight">
            9 conseils 
            <br />
            <span className="italic">pour un bon départ</span>
          </h1>

          <div data-reveal data-reveal-delay="300" className="w-16 h-px bg-gradient-to-r from-transparent via-primary-foreground/50 to-transparent mx-auto mb-8" />
      ...
      <section ref={introRef} className="py-20 md:py-28 bg-background">
        <div className="container-main mx-auto px-6 md:px-12">
          <div className="max-w-3xl mx-auto text-center">
            <p data-reveal className="text-xl text-muted-foreground leading-relaxed md:text-xl">
      ...
      <section className="bg-secondary">
        ...
        <div ref={tip1Ref} className="min-h-[80vh] grid lg:grid-cols-2">
          <div className="relative min-h-[40vh] lg:min-h-full">
            <img data-reveal alt="Choix du lieu" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/f05347d8-d69d-4427-a1b4-540f27c45676.png" />
          ...
          <div className="flex items-center justify-center p-10 md:p-16 lg:p-20 bg-background">
            <div className="max-w-md">
              ...
              <h2 data-reveal data-reveal-delay="150" className="font-heading text-3xl md:text-4xl text-foreground mb-6">Choix du lieu</h2>
        ...
        <div ref={tip2Ref} className="min-h-[80vh] grid lg:grid-cols-2">
          <div className="flex items-center justify-center p-10 md:p-16 lg:p-20 bg-primary text-primary-foreground order-2 lg:order-1">
            <div className="max-w-md">
              <div data-reveal className="w-14 h-14 border border-primary-foreground/30 flex items-center justify-center mb-8">
                <User className="h-7 w-7 text-primary-foreground" />
              </div>
              <h2 data-reveal data-reveal-delay="150" className="font-heading text-3xl md:text-4xl mb-6">Attitude et posture</h2>
              <div data-reveal data-reveal-delay="250" className="w-16 h-px bg-gradient-to-r from-transparent via-primary-foreground/30 to-transparent mb-8" />
              <p data-reveal data-reveal-delay="350" className="text-primary-foreground/80 leading-relaxed mb-6 text-xl">
          ...
          <div className="relative min-h-[40vh] lg:min-h-full order-1 lg:order-2">
            <img data-reveal alt="Attitude naturelle" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/93d1a4e4-1ae1-4877-833e-2837edaa9aaf.jpg" />
        ...
        <div ref={tip3Ref} className="min-h-[80vh] grid lg:grid-cols-2">
          <div className="relative min-h-[40vh] lg:min-h-full">
            <img data-reveal alt="Tenue vestimentaire" className="absolute inset-0 w-full h-full object-cover" src="/lovable-uploads/44f0837a-3c91-4cf2-9770-be878baca5a9.png" />
            <div className="absolute top-10 left-10">
          ...
          <div className="flex items-center justify-center p-10 md:p-16 lg:p-20 bg-secondary">
            <div className="max-w-md">
              ...
              <h2 data-reveal data-reveal-delay="150" className="font-heading text-3xl md:text-4xl text-foreground mb-6">Tenue vestimentaire</h2>
              <div data-reveal data-reveal-delay="250" className="divider-gold mb-8" />
              <p data-reveal data-reveal-delay="350" className="text-muted-foreground leading-relaxed mb-6 text-xl">
      ...
      <section ref={tipsGridRef} className="section-luxury bg-background">
        <div className="container-main mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 data-reveal data-reveal-delay="150" className="font-heading text-4xl md:text-5xl text-foreground">Conseils complémentaires</h2>
          </div>
