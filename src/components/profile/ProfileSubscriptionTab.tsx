        ...
        <DialogContent className="sm:max-w-xl p-0 overflow-hidden rounded-[2rem] border-0 shadow-2xl bg-white">
          <div className="px-8 sm:px-12 py-10 space-y-6">
            ...
            <div className="text-center space-y-3">
              ...
              <h2 className="font-heading font-medium text-foreground text-3xl">
            ...
            <div className="space-y-4 py-2">
              {[
                { icon: EyeOff, title: "Discrétion absolue", desc: "Votre profil devient instantanément invisible pour les autres membres." },
                { icon: Heart, title: "Données conservées", desc: "Vous gardez l'accès à vos messages jusqu'à la fin du mois réglé." },
                { icon: Bell, title: "Zéro mauvaise surprise", desc: "Nous vous enverrons un e-mail pour vous prévenir avant la réactivation." }
              ].map((item) => (
                <div key={item.title} className="flex items-start gap-4 p-4 rounded-2xl bg-secondary/50 border border-secondary text-left">
