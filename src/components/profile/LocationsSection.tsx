...
const COUNTRIES = [
  ...
  { code: "GB", name: "Royaume-Uni (Angleterre)", flag: "🇬🇧" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border-2 border-slate-200 rounded-[24px] p-8 shadow-sm relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex flex-col h-full">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg font-bold uppercase tracking-widest mb-8 text-2xl bg-[#0e172a] text-slate-50">
        ...
        <DialogContent className="max-w-md p-0 overflow-hidden bg-white border-0 rounded-[24px]">
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              <button
                type="button"
                onClick={() => setDestType("france")}
                className={`h-14 rounded-xl font-bold border-2 transition-all ${
                  destType === "france"
                    ? "bg-[#1B2333] text-white border-[#1B2333] text-xl"
                    : "bg-slate-50 text-slate-500 border-slate-200 hover:border-slate-300 text-xl"
                }`}
              >
                🇫🇷 En France
              </button>
