...
const CONCIERGE_BENEFITS = [
  ...
  "Nous remplissons ensemble l'intégralité de votre profil pour vous",
...
const STEPS = [
  ...
  },
  {
    ...
    highlights: ["Vos habitudes et vos valeurs ", "Portrait de votre futur partenaire ", "Vos passions et vos attentes"],
  },
  {
    number: "04",
    icon: Brain,
    ...
    duration: "15 min",
    description: "Un test psychologique simple pour réussir vos rencontres. ",
        ...
        {activeStep === 0 && (
          <div className="max-w-4xl w-full text-center space-y-8 animate-in zoom-in-95 duration-500">
            <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-gold/30 bg-gold/5 mb-4">
              ...
              <span className="font-bold tracking-[0.2em] uppercase text-gold sm:text-base text-2xl">
