  ...
  ({ className, type, onChange, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          "flex h-12 w-full rounded-xl border border-input bg-background px-4 py-2 ring-offset-background file:border-0 file:bg-transparent file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-xl",
          className,
        )}
        ref={ref}
        {...props}
