...
const ToastTitle = React.forwardRef<
  ...
  ({ className, ...props }, ref) =>
  <ToastPrimitives.Title ref={ref} className={cn("font-heading font-semibold text-lg text-[#1B2333]", className)} {...props} />
);
...
const ToastDescription = React.forwardRef<
  ...
  ({ className, ...props }, ref) =>
  <ToastPrimitives.Description ref={ref} className={cn("opacity-90 text-base text-foreground", className)} {...props} />
);
