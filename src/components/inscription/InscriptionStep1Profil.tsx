...
export default function Inscription() {
    ...
    return (
      <div className="h-screen flex overflow-hidden bg-white">
        <div className="flex-1 flex flex-col justify-center px-12 text-center">
          ...
          <div className="w-20 h-10 flex items-center justify-center mx-auto mb-6">
            <Clock className="h-10 w-10 text-[hsl(var(--gold))]" />
          </div>
          <h1 className="text-3xl font-bold mb-4">Merci, {formData.firstName} !</h1>
          <p className="text-muted-foreground text-xl mb-8">Validation en cours sous 24h.</p>
  ...
  return (
    <div className="h-screen w-full flex overflow-hidden bg-white">
      {/* COLONNE GAUCHE - INTERFACE FIXE AVEC SCROLL INTERNE */}
      <div className="flex-1 h-full overflow-y-auto scrollbar-hide flex flex-col">
        <div className="flex-1 flex flex-col px-6 py-10 md:px-16 lg:px-20 max-w-lg w-full mx-auto">
          <Link to="/" className="font-heading text-3xl font-bold text-[#1B2333] mb-10 block shrink-0">
            Kalimera
          </Link>
          ...
          <div className="mb-8 shrink-0">
            ...
            <p className="text-muted-foreground mt-3 text-xs font-bold uppercase tracking-[0.2em]">
              Étape {step + 1} / {allSteps.length}
            </p>
          </div>

          <RegistrationLocationHeader />

          {/* ZONE DE CONTENU - ADAPTABILITÉ TOTALE */}
      ...
      {/* COLONNE DROITE - MARKETING & CONNEXION */}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-16 text-center text-white">
          <div className="max-w-md">
            ...
            <div className="pt-10 border-t border-white/10">
              <p className="text-lg mb-6 opacity-70 font-medium">Déjà membre de notre club ?</p>
              <Link
                to="/connexion"
